...
// Concept: the page. All the mass at the bottom, like a text starting at the foot
// of a still-blank sheet. No mark in the background, the OG already plays that
// part: the composition rests on the scale contrast (96 against 30) and the
// tension with the emptiness, nothing else.
